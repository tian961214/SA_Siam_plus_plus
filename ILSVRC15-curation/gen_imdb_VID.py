    ...
    for i in range(len(all_dirs_level1)):
        ...
        for j in range(len(all_dirs_level2)):
            ...
            if vid_idx < train_video_num:
                if all_dirs_level2[j] not in videos_train:         #python3修改
                    videos_train[all_dirs_level2[j]] = []
            else:
                if all_dirs_level2[j]  not in videos_val:
            ...
            tmp_keys = list(video_ids.keys())       #python3  修改
...
if __name__ == "__main__":
    vid_root_path = "/home/deeplearning/baba/genzong/data/ILSVRC2015_VID/ILSVRC2015"
    vid_curated_path = "/home/deeplearning/baba/genzong/data/ILSVRC2015_VID/ILSVRC2015_crops"
